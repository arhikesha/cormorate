            ...
            <div id="portfolio" class="portfolio-full-description">
                ...
                <div class="portfolio-full-description-related-projects">
                    ...
                    <div class="related_project">
                        <a class="related_proj related_img" href="{{ route('portfolios.show',['alias'=>$item->alias]) }}" title="Octopus"><img src="{{ asset(env("THEME")) }}/images/projects/{{ $item->img->mini }}" alt="0052" title="0052" /></a>
